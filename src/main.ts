...
const numberOfCharactersEl = document.getElementById("number-of-characters") as HTMLInputElement

formEl.addEventListener("submit", (e) => {
  e.preventDefault()
  resultEl.value = Generator.genRandomText(+numberOfCharactersEl.value, {
